...
class ServiceProvider
{
     ...
     *
     * @param string $layout    The layout of the views
    ...
    /**
     * Renders a views + optional layout
     *
     * @param string $view  The views to render
     * @param array $data   The data to render in the views
     * @return void
     */
    ...
    /**
     * Renders a views without a layout
     *
     * @param string $view  The views to render
     * @param array $data   The data to render in the views
     * @return void
